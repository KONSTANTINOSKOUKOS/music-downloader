    ...
    <ion-tabs>
      ...
      <ion-tab-bar v-if="state.token != ''" slot="bottom">
        <ion-tab-button tab="search" href="/dl">
          ...
          <svg v-else fill="#ffffff80" role="img" height="24" width="24" aria-hidden="true" viewBox="0 0 24 24"
            data-encore-id="icon">
            <path
        ...
        <ion-tab-button tab="lib" href="/library">
          <svg v-if="$route.path == '/library'" fill="#ffffff" role="img" height="24" width="24" aria-hidden="true"
            class="Svg-sc-ytk21e-0 uPxdw collection-active-icon" viewBox="0 0 24 24" data-encore-id="icon">
            <path
...
<!-- 
  LIB NO
<svg role="img" height="24" width="24" fill="currentColor" aria-hidden="true"
